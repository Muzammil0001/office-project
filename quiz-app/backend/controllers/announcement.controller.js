...
exports.createAnnouncement = async (req, res) => {
    try {
        ...
        res.status(400).send({ message: 'Failed to create announcement', error: error.message });
    }
};
...
exports.getAnnouncements = async (req, res) => {
    try {
        ...
        res.status(500).send({ message: 'Failed to retrieve announcements', error: error.message });
    }
};
//Update Announcement<=====================>
...
exports.deleteAnnouncement = async (req, res) => {
    try {
        ...
        res.status(200).send({ message: 'Announcement deleted successfully', announcement });
    } catch (error) {

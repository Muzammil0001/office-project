...
import { getQuizById, updateQuiz } from "../../../apis/quizzes-apis";
...
const QuizPage = () => {
  ...
  return (
    <>
      <div className="h-[100vh] flex sm:items-center justify-center sm:py-10 bg-slate-100">
        <div className="bg-white mx-auto p-5 md:w-[70%] shadow-lg rounded-lg sm:mt-10 mt-5 h-[max-content]">

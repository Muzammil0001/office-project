...
const Quizzes = () => {
  ...
  return (
    <div className="w-full">
      <h2 className="text-center text-3xl font-bold font-nunito mb-10">Quizzes</h2>
          ...
          >
            ...
            <div className="w-full flex sm:flex-row flex-col gap-5 sm:gap-[100px] p-2 justify-center md:justify-end items-center">
              <div className="flex items-center justify-center gap-2">
                ...
                <div className="text-base">{new Date(quiz.dueDate).toLocaleDateString()}</div>
              </div>
              <div className="flex items-center justify-center gap-2">
                <div className="font-medium">Duration:</div>
                <div className="text-base text-nowrap">{quiz.timeLimit} minutes</div>
              </div>
              <div className="flex items-center justify-center gap-2">
                <button

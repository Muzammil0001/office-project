...
const CreateTeacher = ({ isOpenModal, setToClose }) => {
  return (
              ...
              <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <form className="mt-2">
                  ...
                  <div className="mt-4">
                    ...
                    <select
                      name="course"
                      className="mt-1 bg-white block w-full rounded-md border border-slate-500 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm"
                    >
